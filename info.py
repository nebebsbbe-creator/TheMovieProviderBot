...
API_ID = int(environ.get('API_ID', '38306827'))
API_HASH = environ.get('API_HASH', '2be797270be14e4aac4607f56d8a95c1')
BOT_TOKEN = environ.get('BOT_TOKEN', "8505639780:AAEThe2rG9NUgWn-yrTqbex61L9Te_TNmUk")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5514940960').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003932556847').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002785579333') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Cinegrid:Aditya%401234@cluster0.zao6qmt.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cinegrid")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cinegrid1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cinegrid1')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003509323525')) #Log channel id ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003932556847')).split()]
